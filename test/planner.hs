...
duration tt arrivalTime startStation endStation = duration where
    ...
    train = whichTrain (stationIndex startStation (tt !! 0)) arrivalTime

whichTrain :: Int -> String -> Int
whichTrain i runningTime = [t | t <- [1..(length timetable - 1)], (timetable !! t !! i) == runningTime ] !! 0
